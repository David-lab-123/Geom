...
public class PanelLog extends GridPanel {
     ...
     * @param label
     */
    public PanelLog(Window window, boolean drawBG, int backgroundColor, int padding, int gridWidth, int gridHeight, int gridX, int gridY, int colspan, int rowspan, Label label) {
